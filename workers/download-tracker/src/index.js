...
<body>
  <h1>StaticClock</h1>
  <p class="motto">When to release so it is read, not reacted to.</p>
  <div class="card">
    <p class="count">${n}<span> downloads of this project</span></p>
    <a class="dl" href="/download?asset=staticclock-0.1.0.tar.gz">Download staticclock-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>staticclock-download-tracker</code>, project <code>staticclock</code>. Not mixed with any other product.</p>
